...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-sa-related-links-fragment.js
  var import_sa_related_links_fragment_exports = {};
  __export(import_sa_related_links_fragment_exports, {
  ...
  var import_sa_related_links_fragment_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_sa_related_links_fragment_exports);
})();
